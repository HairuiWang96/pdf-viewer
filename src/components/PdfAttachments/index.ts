export { default as BottomBarAttachments } from './BottomBarAttachments';
export { default as ToolbarAttachments } from './ToolbarAttachments';
...
export type { AttachmentPlacement, PlacementOption } from './placement';
